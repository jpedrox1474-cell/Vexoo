...
import {
  PawPrint, Syringe, FileText, BedDouble, Package, DollarSign, HeartPulse,
...
export default function VeterinariaInfo() {
  const module = {
    name: "VetPro System",
    ...
    deepDive: [
      {
        ...
        image: "/images/vetpro_gallery.png"
      },
      {
          ...
          {module.deepDive.map((item, idx) => (
            <div key={idx} className={`flex flex-col ${idx % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-16`}>
              ...
              <div className="lg:w-1/2">
                ...
                <button className="flex items-center gap-2 text-blue-600 hover:gap-4 transition-all font-bold">
