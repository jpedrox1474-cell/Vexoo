...
export default function BarberProInfo() {
  const module = {
    ...
    image: "https://images.unsplash.com/photo-1503951914875-452162b7f300?auto=format&fit=crop&w=1920&q=80",
    gallery: [
      "https://images.unsplash.com/photo-1599351431202-6e0005a741a3?auto=format&fit=crop&w=800&q=80",
      ...
      <nav className="sticky top-0 z-50 bg-white/85 backdrop-blur-xl border-b border-slate-200/60 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link to={createPageUrl('ModulesDashboard')} className="px-6 py-3 rounded-full font-bold text-sm bg-gradient-to-r from-indigo-500 to-purple-500 hover:brightness-110 text-white shadow-lg shadow-indigo-500/30 transition-all">
              Teste Grátis
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to={createPageUrl('ModulesDashboard')} className="text-lg px-8 py-5 rounded-2xl shadow-xl bg-gradient-to-r from-indigo-500 to-purple-500 hover:brightness-110 text-white font-bold text-center transition-all">
        ...
        <div className="max-w-5xl mx-auto bg-slate-900 rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to={createPageUrl('ModulesDashboard')} className={`px-10 py-5 rounded-full bg-gradient-to-r ${module.color} text-white font-bold text-lg shadow-lg hover:brightness-110 transition-all`}>
