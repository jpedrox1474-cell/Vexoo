...
import {
  Dumbbell, BrainCircuit, Activity, Target, CreditCard, Smartphone, FileText,
...
export default function AcademiaInfo() {
  const module = {
    ...
    gallery: [
      "/images/elitetraining_gallery.png",
      "/images/elitetraining_gallery.png",
      "/images/elitetraining_gallery.png"
    ],
    stats: [
    ...
    deepDive: [
      {
        ...
        image: "/images/elitetraining_gallery.png"
      },
      {
          ...
          {module.deepDive.map((item, idx) => (
            <div key={idx} className={`flex flex-col ${idx % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-16`}>
              ...
              <div className="lg:w-1/2">
                ...
                <button className="flex items-center gap-2 text-orange-600 hover:gap-4 transition-all font-bold">
